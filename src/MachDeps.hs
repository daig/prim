...
-- | This module exposes machine-dependent constants from GHC's @MachDeps.h@ header.
-- It's meant for documentation and convenience /only/. In actual use one should
-- import the macro constants directly from @MachDeps.h@ like so:
--
-- @{-\# language CPP \#-}@
--
-- @#include "MachDeps.h"@
module MachDeps where
