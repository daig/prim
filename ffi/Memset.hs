{-# LANGUAGE LinearTypes,MagicHash, UnliftedFFITypes #-}
...
foreign import ccall unsafe "primitive-memops.h hsprimitive_memset_Word8"
  setWord8Array# ∷ MutableByteArray# s → Int# {- ^ diff -} → Int# {- ^ size -}→ Word# → IO ()
foreign import ccall unsafe "primitive-memops.h hsprimitive_memset_Word16"
  setWord16Array# ∷ MutableByteArray# s → Int# {- ^ diff -} → Int# {- ^ size -}→ Word# → IO ()
foreign import ccall unsafe "primitive-memops.h hsprimitive_memset_Word32"
  setWord32Array# ∷ MutableByteArray# s → Int# {- ^ diff -} → Int# {- ^ size -}→ Word# → IO ()
foreign import ccall unsafe "primitive-memops.h hsprimitive_memset_Word64"
  setWord64Array# ∷ MutableByteArray# s → Int# {- ^ diff -} → Int# {- ^ size -}→ Word# → IO ()
...
foreign import ccall unsafe "primitive-memops.h hsprimitive_memset_Word8"
  setInt8Array# ∷ MutableByteArray# s → Int# {- ^ diff -} → Int# {- ^ size -} → Int# → IO ()
foreign import ccall unsafe "primitive-memops.h hsprimitive_memset_Word16"
  setInt16Array# ∷ MutableByteArray# s → Int# {- ^ diff -} → Int# {- ^ size -} → Int# → IO ()
foreign import ccall unsafe "primitive-memops.h hsprimitive_memset_Word32"
  setInt32Array# ∷ MutableByteArray# s → Int# {- ^ diff -} → Int# {- ^ size -} → Int# → IO ()
foreign import ccall unsafe "primitive-memops.h hsprimitive_memset_Word64"
  setInt64Array# ∷ MutableByteArray# s → Int# {- ^ diff -} → Int# {- ^ size -} → Int# → IO ()
foreign import ccall unsafe "primitive-memops.h hsprimitive_memset_Word"
...
foreign import ccall unsafe "primitive-memops.h hsprimitive_memset_Word8"
  setWord8OffAddr# ∷ Addr# → Int# {- ^ diff -} → Int# {- ^ size -}→ Word# → IO ()
foreign import ccall unsafe "primitive-memops.h hsprimitive_memset_Word16"
  setWord16OffAddr# ∷ Addr# → Int# {- ^ diff -} → Int# {- ^ size -}→ Word# → IO ()
foreign import ccall unsafe "primitive-memops.h hsprimitive_memset_Word32"
  setWord32OffAddr# ∷ Addr# → Int# {- ^ diff -} → Int# {- ^ size -}→ Word# → IO ()
foreign import ccall unsafe "primitive-memops.h hsprimitive_memset_Word64"
  setWord64OffAddr# ∷ Addr# → Int# {- ^ diff -} → Int# {- ^ size -}→ Word# → IO ()
foreign import ccall unsafe "primitive-memops.h hsprimitive_memset_Word"
  setWordOffAddr# ∷ Addr# → Int# {- ^ diff -} → Int# {- ^ size -}→ Word# → IO ()
foreign import ccall unsafe "primitive-memops.h hsprimitive_memset_Word8"
  setInt8OffAddr# ∷ Addr# → Int# {- ^ diff -} → Int# {- ^ size -} → Int# → IO ()
foreign import ccall unsafe "primitive-memops.h hsprimitive_memset_Word16"
  setInt16OffAddr# ∷ Addr# → Int# {- ^ diff -} → Int# {- ^ size -} → Int# → IO ()
foreign import ccall unsafe "primitive-memops.h hsprimitive_memset_Word32"
  setInt32OffAddr# ∷ Addr# → Int# {- ^ diff -} → Int# {- ^ size -} → Int# → IO ()
foreign import ccall unsafe "primitive-memops.h hsprimitive_memset_Word64"
  setInt64OffAddr# ∷ Addr# → Int# {- ^ diff -} → Int# {- ^ size -} → Int# → IO ()
foreign import ccall unsafe "primitive-memops.h hsprimitive_memset_Word"
